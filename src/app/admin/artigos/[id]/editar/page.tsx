    ...
    <div className="max-w-2xl">
      ...
      <form action={updateArticle} className="bg-white rounded-lg border border-gray-200 p-6 space-y-5">
        ...
        <div>
          ...
          <textarea id="content" name="content" rows={12} defaultValue={article.content} placeholder="Escreva o conteúdo completo do artigo aqui. Separe os parágrafos com uma linha em branco." className={`${inputClass} resize-y`} />
        </div>
